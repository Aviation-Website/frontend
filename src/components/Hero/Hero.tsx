...
export function Hero() {
  return (
    <section className="relative min-h-screen w-full bg-white flex flex-col lg:flex-row items-center justify-center px-4  pb-10 overflow-hidden">
      ...
      <div className="max-w-7xl w-full mx-auto grid grid-cols-1 gap-12 lg:grid-cols-2 lg:items-center relative z-10">
        ...
        <div className="flex flex-col items-center lg:items-start space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
            <a
              href="/register"
              className="group relative px-8 py-4 bg-[#3271b1] text-white font-bold rounded-xl hover:bg-[#285a8c] transition-all duration-300 shadow-lg hover:shadow-blue-500/30 flex items-center justify-center gap-2 hover:-translate-y-1"
            >
            ...
            <a
              href="/about"
              className="group px-8 py-4 bg-transparent text-[#152351] font-bold rounded-xl border-2 border-[#152351] hover:bg-[#152351] hover:text-white transition-all duration-300 flex items-center justify-center gap-2 hover:-translate-y-1"
            >
              Learn More
