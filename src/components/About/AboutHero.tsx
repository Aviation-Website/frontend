            ...
            >
              ...
              >
                ...
                <path
                  ...
                  className={`transition-colors duration-200 ${
                    activeId === "cockpit" ? "fill-sky-400" : "fill-slate-500"
                  }`}
                />
              ...
              >
                ...
                <polygon
                  ...
                  className={`transition-colors duration-200 ${
                    activeId === "leftWing" ? "fill-sky-400" : "fill-slate-500"
                  }`}
                />
              ...
              >
                ...
                <polygon
                  ...
                  className={`transition-colors duration-200 ${
                    activeId === "rightWing" ? "fill-sky-400" : "fill-slate-500"
                  }`}
                />
                {/* inboard flap / spoiler section */}
                <polygon
              ...
              >
                ...
                <polygon
                  ...
                  className={`transition-colors duration-200 ${
                    activeId === "tail" ? "fill-sky-400" : "fill-slate-600"
                  }`}
                />
                <polygon
                ...
                <path
                  ...
                  className={`transition-colors duration-200 ${
                    activeId === "tail" ? "fill-sky-300" : "fill-slate-500"
                  }`}
                />
              </g>
